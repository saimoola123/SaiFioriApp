			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SaiFioriApp-display": {
								"semanticObject": "SaiFioriApp",
								"action": "display",
								"description": "Fiori App Demonistration",
								"title": "Sai Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sai.moola.SaiFioriDemo",
									"url": sap.ui.require.toUrl("sai/moola/SaiFioriDemo")
								}
							}
						}
					}
